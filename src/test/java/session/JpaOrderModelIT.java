...
/**
 * set <property name="hbm2ddl.auto">update</property> in hibernate.cfg or
 * persistence.xml
 */
@Ignore
public class JpaOrderModelIT {
    ...
    public static void setup() {
        ...
        try (Connection connection = DriverManager.getConnection(url, "root", "carpond")) {
    ...
    private static String[] commands = {
            ...
            "insert into Film (title, released, stock, genre, version) values ('The Shawshank Redemption','1994-01-01',0,'DRAMA',0);",
